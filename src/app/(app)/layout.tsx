  ...
  return (
    <div className="min-h-svh">
      <header className="sticky top-0 z-40 border-b bg-background/88 shadow-sm shadow-primary/5 backdrop-blur-xl">
        <div className="mx-auto flex min-h-14 max-w-6xl items-center justify-between gap-2 px-3 py-2 sm:gap-3 sm:px-4">
          <Link
            href="/"
      ...
      <main className="mx-auto w-full max-w-6xl px-4 py-5 pb-8 sm:py-6">{children}</main>
      <OfflineStatus />
    </div>
  );
}
